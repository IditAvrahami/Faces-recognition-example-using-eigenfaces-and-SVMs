...
#Dispaly variance vs PC plot
plt.figure(figsize=(4, 4))
plt.plot([i for i in range(150)],pca.explained_variance_ratio_ *100)
plt.xlabel("PC #")
plt.ylabel("variance [%]")
plt.suptitle("variance vs. PC #", fontsize=16)
plt.show()
...
plot_gallery(X_test, prediction_titles, h, w,7,7)
# %%
# plot the gallery of the most significative eigenfaces

eigenface_titles = ["eigenface %d" % i for i in range(eigenfaces.shape[0])]
plot_gallery(eigenfaces, eigenface_titles, h, w,7,7)
